...
export async function loadTournamentConfig() {
    try {
        ...
        if (snap.exists()) {
            ...
            // Support both old format (tournamentId) and new format (activeTournamentIds + selectedTournamentId)
